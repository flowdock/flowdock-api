      ...
      if branch == current_branch || stage == :production
        ...
        unless commits.empty?
          commits.each do |c|
            ...
            message << "\n<div style=\"margin-bottom: 10px\"><div style=\"height:30px;width:30px;float:left;margin-right:5px;\"><img src=\"https://secure.gravatar.com/avatar/#{MD5::md5(c.author.email.downcase)}?s=30\" /></div>"
